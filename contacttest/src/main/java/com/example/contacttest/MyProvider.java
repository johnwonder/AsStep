...
public class MyProvider extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI("com.example.contacttest.provider","table1#",TABLE1_ITEM);
        uriMatcher.addURI("com.example.contacttest.provider","table2",TABLE2_ITEM);
    ...
    public String getType(Uri uri) {
       switch (uriMatcher.match(uri)) {
           case TABLE1_DIR:
               return "vnd.android.cursor.dir/vnd.com.example.comtacttest.provider.table1";
           case TABLE1_ITEM:
